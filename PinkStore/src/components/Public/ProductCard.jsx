...
function ProductCard({ product, onAddToCart }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-pink-100">
      <div className="bg-gradient-to-br from-pink-300 via-pink-400 to-rose-400 h-56 flex items-center justify-center relative">
      ...
      <div className="p-6">
        ...
        <button
          onClick={handleBuy}
          className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 transition shadow-lg"
        >
